...
Observed output (combined across the full run and the grok rerun after the advisory-skip narrowing landed; the grok note predates the later live-reviewer busy skip):
