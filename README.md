...
| `/reckon`          | Self-audit the session and fleet for missed or leftover work - traverse every task and decision this session touched, reconcile durable records against repo and PR reality, and report what is unfinished, unpushed, or silently diverged |
